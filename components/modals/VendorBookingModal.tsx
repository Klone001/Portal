...
const VendorBookingModal: React.FC<{ open: boolean; setOpen: React.Dispatch<React.SetStateAction<boolean>> }> = ({ open, setOpen }) => {
        ...
        <PopupModal
            ...
            <div className="flex items-center justify-between flex-wrap gap-3 mb-5">
                ...
                <div className="flex items-center gap-x-3">
                    ...
                    <h2 className="text-black text-sm md:text-base font-medium">Booking</h2>
