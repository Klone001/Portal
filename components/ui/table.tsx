...
const TableHead: React.FC<{
    ...
    return (
        <th scope={scope} className={cn("py-3 text-left whitespace-nowrap font-normal", className)}>
            {children}
        </th>
    );
};
...
const TableHeader: React.FC<{
    ...
    return (
        <thead className={cn("bg-white text-gray-700 border-t border-gray-200 text-xs font-light", className)}>
            {children}
        </thead>
    );
};
